class Urls {
  ...
  static const String getCancelledTasksUrl = "$baseUrl/listTaskByStatus/Cancelled";
  static const String getCompletedTasksUrl = "$baseUrl/listTaskByStatus/Completed";
